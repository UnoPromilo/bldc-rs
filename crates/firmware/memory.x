...
MEMORY
{
    BOOTLOADER                        : ORIGIN = BOOTLOADER_ORIGIN, LENGTH = BOOTLOADER_SIZE
    BOOTLOADER_STATE                  : ORIGIN = BOOTLOADER_STATE_ORIGIN, LENGTH = BOOTLOADER_STATE_SIZE
    FLASH                             : ORIGIN = ACTIVE_ORIGIN, LENGTH = ACTIVE_SIZE
...
__settings_start = ORIGIN(SETTINGS) - BANK1_ORIGIN;
__settings_end = ORIGIN(SETTINGS) + LENGTH(SETTINGS) - BANK1_ORIGIN;